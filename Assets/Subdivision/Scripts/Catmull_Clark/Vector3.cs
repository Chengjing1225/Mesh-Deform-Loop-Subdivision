...
namespace Subdivision.Core
{
    public struct Vector3
    {
        ...
        //public static double AngleCos(Vector3 v0, Vector3 v1)
        //{
        //    double pointMultply = (v0.X * v1.X) + (v0.Y * v1.Y) + (v0.Z * v1.Z);
        //    double v0_val = v0.Length();
        //    double v1_val = v1.Length();
        //    double cosM = pointMultply / (v0_val * v1_val);
        //    return cosM;
        //}
        public  double AngleCos(Vector3 v0)
        {
            double pointMultply = (v0.X * X) + (v0.Y * Y) + (v0.Z * Z);
            double v0_val = v0.Length();
            if (v0_val == 0)
                return 0; 
            double val = Length();
            double cosM = pointMultply / (v0_val * val);
            return cosM;
        }
